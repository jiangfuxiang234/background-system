  ...
  <div class="app-container">
    ...
    <el-table :data="data" style="width: 100%" border>
      ...
      <el-table-column prop="title" label="所属分类" width="150" align="center">
        ...
        <!-- 如果将某个文章分类删除了，则该分类下的文章就获取不到分类，所以这里要进行判断一下 -->
      </el-table-column>
...
export default {
  ...
  methods:{
    ...
    goToTitleHandle(blogInfo){
      console.log(`${frontEnd_URL}/article/${blogInfo.id}`);
    ...
    prevClickHandle(){   // 当页码改变时都会触发currentChangeHandle事件，
      this.currentPage-- // 所以在上下页函数里可以不用重新获取数据
    },
    nextClickHandle(){
      this.currentPage++
    }
